...
The [MineOS Turnkey ISO](https://my.syncplicity.com/share/8t6enbd00wymdfq/mineos-node_bullseye-x64) is approximately 700MB and supports x86_64 architectures only. (Not Working)
